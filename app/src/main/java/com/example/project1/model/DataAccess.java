...
public class DataAccess implements myInterface{
    ...
    public DataAccess() {
        ...
        //-------------------------------------------------------------------------------
        haveToDo.add(new HaveToDo("adults","obesity","Consume less “bad” fat and more “good” fat\n" +
        ...
        avoids.add(new Avoid("kids","obesity","Breastfeed infants, when possible\n" +
                ...
                "Make sure everyone is getting enough sleepg"));
        //---------------------------------------------------------------------------------
        avoids.add(new Avoid("adults","'UnderWeight'","not playing some exersices\n" +
                "not eating some vitamens.\n" +
                "not eating 3 regular meals a day with some healthy snacks in between.\n" +
                "eating too much unhealthy food"));
        //-------------------------------------------------------------------------------
        avoids.add(new Avoid("adults","obesity","eating large amounts of processed or fast food \n" +
                "eating larger portions than you need\n" +
                "drinking too many sugary drinks\n" +
                "comfort eating \n" +
                "Lacking of physical activity"));
    }
